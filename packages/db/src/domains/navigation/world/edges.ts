...
export const WORLD_EDGES: Array<Edge> = [
  ...
  { from: 'rare_animal', to: 'tequila_wolf', via: 'sea_east_blue', baseDurationBuckets: EAST_BLUE_TRAVEL_DURATION },
  { from: 'kumate', to: 'sixis', via: 'sea_east_blue', baseDurationBuckets: EAST_BLUE_TRAVEL_DURATION },
  { from: 'kumate', to: 'tequila_wolf', via: 'sea_east_blue', baseDurationBuckets: EAST_BLUE_TRAVEL_DURATION },
  { from: 'sixis', to: 'tequila_wolf', via: 'sea_east_blue', baseDurationBuckets: inBuckets('1h') },
