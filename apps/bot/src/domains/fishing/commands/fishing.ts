...
import { runFishingAttempt } from '../services/index.js';
import { buildFishingOutcomeEmbed } from '../views/index.js';
...
export const fishingCommand: Command = {
  ...
  async handler(ctx) {
    ...
    await ctx.message.reply({ embeds: [buildFishingOutcomeEmbed(result)] });
  },
};
