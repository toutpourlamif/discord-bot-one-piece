...
export function buildCrewNavButton(ownerDiscordId: string, playerId: number, options?: { disabled?: boolean }): ButtonBuilder {
  return (
    new ButtonBuilder()
      ...
      .setCustomId(options?.disabled ? `menu-characters-disabled` : buildCustomId(CREW_BUTTON_NAME, ownerDiscordId, playerId, FIRST_PAGE))
      .setLabel('Équipage')
