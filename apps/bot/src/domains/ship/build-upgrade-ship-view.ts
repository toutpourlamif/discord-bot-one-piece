import { SHIP_MODULE_KEYS, SHIP_MODULE_LEVEL_COLUMNS, type Ship, type ShipModuleKey } from '@one-piece/db';
...
import {
  CONFIRM_SHIP_MODULE_UPGRADE_BUTTON_NAME,
  UPGRADE_MODULE_EMOJI,
  UPGRADE_SHIP_BUTTON_NAME,
  UPGRADE_SHIP_MODULE_BUTTON_NAME,
} from './constants.js';
